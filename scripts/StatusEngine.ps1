...
function Get-CodexSessionState {
    param(
        [Parameter(Mandatory)]
...
function Get-CodexTrafficState {
    param(
    ...
    $states = @($relevantFiles | ForEach-Object { Get-CodexSessionState -File $_ })
